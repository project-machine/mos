...
function common_setup {
	export ROOTFS_VERSION="${ROOTFS_VERSION:-v0.0.14.230901}"
	...
	[ -e ${TOPDIR}/hack/tools/bin/trust ] || {
		...
		wget -O ${TOPDIR}/hack/tools/bin/trust https://github.com/project-machine/trust/releases/download/v0.0.12/trust-linux-amd64
